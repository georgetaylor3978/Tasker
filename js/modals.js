...
const Modals = (() => {
  ...
  const prepareTaskModal = (taskId, moduleId, stackId, standalone = false) => {
    ...
    // Show/hide stack and rank for standalone tasks
    document.getElementById('task-stack-group').style.display = standalone ? 'none' : '';
    document.getElementById('task-rank-group').style.display  = standalone ? 'none' : '';
